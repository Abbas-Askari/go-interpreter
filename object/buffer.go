...
func (b Buffer) Add(o Object) Object {
	arr, ok := o.(Buffer)
	if !ok {
		fmt.Println("Cannot add Buffer with", o)
		return nil
	}
	return NewBuffer(append(b.Value, arr.Value...))
}

func (b Buffer) Sub(o Object) Object {
	panic("Cannot subtract Buffers")
}

func (b Buffer) Mul(o Object) Object {
	panic("Cannot multiply Arrays")
}

func (b Buffer) Div(o Object) Object {
