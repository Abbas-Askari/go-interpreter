...
func (b Array) Add(o Object) (Object, error) {
	arr, ok := o.(Array)
	if !ok {
		return Nil{}, fmt.Errorf("can only add Array to Array, got %s", o.Type())
	}
	return NewArray(append(b.Value, arr.Value...)), nil
}

func (b Array) Sub(o Object) (Object, error) {
	return Nil{}, fmt.Errorf("cannot subtract from Array")
}

func (b Array) Mul(o Object) (Object, error) {
	return Nil{}, fmt.Errorf("cannot multiply Array")
}

func (b Array) Div(o Object) (Object, error) {
	return Nil{}, fmt.Errorf("cannot divide Array")
}
