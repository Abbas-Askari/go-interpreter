...
func (b String) Add(o Object) (Object, error) {
	return NewString(b.Value + fmt.Sprint(o)), nil
}

func (b String) Sub(o Object) (Object, error) {
	return Nil{}, fmt.Errorf("cannot subtract from String")
}

func (b String) Mul(o Object) (Object, error) {
	return Nil{}, fmt.Errorf("cannot multiply String")
}

func (b String) Div(o Object) (Object, error) {
