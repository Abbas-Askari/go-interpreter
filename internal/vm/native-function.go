...
func (b NativeFunction) Add(o object.Object) (object.Object, error) {
	return object.Nil{}, fmt.Errorf("cannot perform arithmetic operations on NativeFunction")
}

func (b NativeFunction) Sub(o object.Object) (object.Object, error) {
	return object.Nil{}, fmt.Errorf("cannot perform arithmetic operations on NativeFunction")
}

func (b NativeFunction) Mul(o object.Object) (object.Object, error) {
	return object.Nil{}, fmt.Errorf("cannot perform arithmetic operations on NativeFunction")
}

func (b NativeFunction) Div(o object.Object) (object.Object, error) {
	return object.Nil{}, fmt.Errorf("cannot perform arithmetic operations on NativeFunction")
}
